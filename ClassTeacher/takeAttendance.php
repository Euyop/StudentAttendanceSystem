            ...
            <div class="row">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-success">All Student in (<?php echo $rrw['className'].' - '.$rrw['classArmName'];?>) Class</h6>
                  <h6 class="m-0 font-weight-bold text-warning">Note: <i>Click on the checkboxes to take attendance!</i></h6>
                </div>
                ...
                <?php echo $statusMsg; ?>
                  ...
                  <br>
                  <button type="submit" name="save" class="btn btn-success">Take Attendance</button>
                  </form>
                </div>
              </div>
            </div>
